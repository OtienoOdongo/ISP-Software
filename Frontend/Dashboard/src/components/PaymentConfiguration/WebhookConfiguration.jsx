...
// src/components/PaymentConfiguration/WebhookConfiguration.jsx
import React from 'react';
import { FiCode, FiCopy, FiInfo } from 'react-icons/fi';
      ...
      <div className="space-y-4">
        ...
        <div className={`p-4 rounded-md ${infoClass}`}>
          <div className="flex">
            ...
            <div className="ml-3">
              <p className={`text-sm ${infoTextClass}`}>
                Ensure your server is configured to accept POST requests at the callback URL
              </p>
              <p className={`text-xs mt-1 ${infoTextClass}`}>
                The system will automatically send payment status updates to this endpoint
              </p>
            </div>
          </div>
        </div>
