...
//         <div className={`flex-shrink-0 p-2 rounded-lg ${methodInfo.color} mr-3`}>
//           {methodInfo.icon}
//         </div>
//         <div className="flex-1 min-w-0">
//           <h3 className="text-lg font-medium text-gray-900 truncate">{methodInfo.label}</h3>
//           <p className="text-sm text-gray-500 truncate">{methodInfo.description}</p>
...
//           {method.transactionLimit ? `Limit: KES ${parseInt(method.transactionLimit).toLocaleString()}` : 'No limit'}
//         </span>
//       </div>
//     </div>
//   );
...
//         </div>
//         <div className="flex-1 min-w-0">
//           <h3 className="text-lg font-semibold text-gray-900 truncate">{methodInfo.label}</h3>
//           <p className="text-sm text-gray-500 mt-1">{methodInfo.description}</p>
...
//               {method.isActive ? 'Secured' : 'Inactive'}
//             </span>
//           </div>
