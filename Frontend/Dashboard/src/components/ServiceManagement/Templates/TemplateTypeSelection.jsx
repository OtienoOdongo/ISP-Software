...
// import { Check, ArrowLeft, Wifi, Cable, Box } from "lucide-react";
...
//         {/* Hotspot Template Option */}
//         <motion.div
//           whileHover={{ scale: 1.02 }}
//           whileTap={{ scale: 0.98 }}
//           onClick={() => onTemplateTypeSelect("hotspot")}
//           className={`p-6 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
//             templateType === "hotspot"
//               ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20"
//               : `${themeClasses.border.light} ${themeClasses.bg.card} hover:border-blue-300`
//           }`}
//         >
...
//                 templateType === "hotspot" ? "text-blue-600" : "text-gray-600"
//               }`} />
//             </div>
//             <div className="ml-4">
//               <h4 className={`text-lg font-semibold ${
//                 templateType === "hotspot" ? "text-blue-700" : themeClasses.text.primary
//               }`}>
//                 Hotspot Template
//               </h4>
//               <p className="text-sm text-gray-600 dark:text-gray-400">
//                 Wireless access for multiple users
//               </p>
//             </div>
//           </div>
...
//                 templateType === "hotspot" ? "text-blue-600" : "text-gray-400"
//               }`} />
//               <span>Multi-user session management</span>
//             </div>
//             <div className="flex items-center text-sm">
//               <Check className={`w-4 h-4 mr-2 ${
//                 templateType === "hotspot" ? "text-blue-600" : "text-gray-400"
//               }`} />
//               <span>Bandwidth and data limits</span>
//             </div>
//             <div className="flex items-center text-sm">
//               <Check className={`w-4 h-4 mr-2 ${
//                 templateType === "hotspot" ? "text-blue-600" : "text-gray-400"
//               }`} />
//               <span>Device connection limits</span>
//             </div>
//           </div>
//         </motion.div>

//         {/* PPPoE Template Option */}
//         <motion.div
//           whileHover={{ scale: 1.02 }}
//           whileTap={{ scale: 0.98 }}
//           onClick={() => onTemplateTypeSelect("pppoe")}
//           className={`p-6 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
//             templateType === "pppoe"
//               ? "border-green-500 bg-green-50 dark:bg-green-900/20"
//               : `${themeClasses.border.light} ${themeClasses.bg.card} hover:border-green-300`
//           }`}
//         >
//           <div className="flex items-center mb-4">
//             <div className={`p-3 rounded-lg ${
...
//                 templateType === "pppoe" ? "text-green-600" : "text-gray-600"
//               }`} />
//             </div>
//             <div className="ml-4">
//               <h4 className={`text-lg font-semibold ${
//                 templateType === "pppoe" ? "text-green-700" : themeClasses.text.primary
//               }`}>
//                 PPPoE Template
//               </h4>
//               <p className="text-sm text-gray-600 dark:text-gray-400">
//                 Wired connections with authentication
//               </p>
//             </div>
//           </div>
...
//             <div className="flex items-center text-sm">
//               <Check className={`w-4 h-4 mr-2 ${
//                 templateType === "pppoe" ? "text-green-600" : "text-gray-400"
//               }`} />
//               <span>IP pool management</span>
//             </div>
//             <div className="flex items-center text-sm">
//               <Check className={`w-4 h-4 mr-2 ${
//                 templateType === "pppoe" ? "text-green-600" : "text-gray-400"
//               }`} />
//               <span>DNS and MTU configuration</span>
//             </div>
//             <div className="flex items-center text-sm">
//               <Check className={`w-4 h-4 mr-2 ${
//                 templateType === "pppoe" ? "text-green-600" : "text-gray-400"
...
//           whileTap={{ scale: 0.95 }}
//         >
//           Continue to {templateType === "hotspot" ? "Hotspot" : "PPPoE"} Configuration
