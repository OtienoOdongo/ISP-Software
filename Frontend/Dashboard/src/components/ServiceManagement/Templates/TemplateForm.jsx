...
const TemplateForm = ({
  ...
  }, [templateType, viewMode, onAccessMethodChange, templateForm.accessMethods]);
  ...
  const validateForm = () => {
    ...
    if (templateForm.basePrice < 0) {
      newErrors.basePrice = "Base price cannot be negative";
    }
    
    const activeMethod = getActiveAccessMethod();
    if (activeMethod.enabled) {
      if (!activeMethod.downloadSpeed.value || parseFloat(activeMethod.downloadSpeed.value) <= 0) {
        newErrors.downloadSpeed = "Download speed must be greater than 0";
      }
      
      if (!activeMethod.uploadSpeed.value || parseFloat(activeMethod.uploadSpeed.value) <= 0) {
  ...
  // Get display value for bandwidth input
  const getBandwidthDisplayValue = (method) => {
    if (bandwidthUnit === 'Mbps') {
      return (templateForm.accessMethods[method].bandwidthLimit / 1000) || '';
    }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                <input
                  ...
                  value={templateForm.basePrice}
                  onChange={(e) => {
                    onFormChange("basePrice", e.target.value);
                    if (errors.basePrice) setErrors({...errors, basePrice: null});
                  }}
                  className={`w-full px-3 py-2 rounded-lg shadow-sm text-sm ${themeClasses.input} ${
                    errors.basePrice ? 'border-red-500 focus:ring-red-500' : ''
                  }`}
                  placeholder="0.00"
                  step="0.01"
                  min="0"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div 
                    ...
                    aria-checked={templateForm.isPublic}
                    role="switch"
                  >
                    <span className={`inline-block h-4 w-4 transform bg-white rounded-full shadow-md transition-transform duration-200 ease-in-out ${
                      templateForm.isPublic ? "translate-x-6" : "translate-x-1"
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className={`p-3 sm:p-4 rounded-lg border ${
              ...
              <div className="flex items-center">
                {isHotspot ? (
                  ...
                  <Cable className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 mr-3 flex-shrink-0" />
                )}
                <div>
            ...
            <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div 
                ...
                aria-checked={activeMethod.enabled}
                role="switch"
              >
                <span className={`inline-block h-4 w-4 transform bg-white rounded-full shadow-md transition-transform duration-200 ease-in-out ${
                  activeMethod.enabled ? "translate-x-6" : "translate-x-1"
            ...
            {activeMethod.enabled && (
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className={`p-3 sm:p-4 rounded-lg border ${themeClasses.border.light} ${theme === 'dark' ? 'bg-blue-900/10' : 'bg-blue-50'}`}>
                  <h4 className="text-sm sm:text-md font-semibold mb-3 sm:mb-4 text-blue-700 dark:text-blue-300 flex items-center">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <input
                          ...
                          value={activeMethod.downloadSpeed.value}
                          onChange={(e) => {
                            onAccessMethodNestedChange(templateType, "downloadSpeed", "value", e.target.value);
                            if (errors.downloadSpeed) setErrors({...errors, downloadSpeed: null});
                          }}
                          className={`flex-1 px-3 py-2 rounded-lg shadow-sm text-sm ${themeClasses.input} ${
                            errors.downloadSpeed ? 'border-red-500 focus:ring-red-500' : ''
                          }`}
                          placeholder="10"
                          min="0.01"
                          step="0.01"
                      ...
                      {errors.downloadSpeed && (
                        <p className="mt-1 text-xs text-red-600">{errors.downloadSpeed}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <input
                          ...
                          value={activeMethod.uploadSpeed.value}
                          onChange={(e) => {
                            onAccessMethodNestedChange(templateType, "uploadSpeed", "value", e.target.value);
                            if (errors.uploadSpeed) setErrors({...errors, uploadSpeed: null});
                          }}
                          className={`flex-1 px-3 py-2 rounded-lg shadow-sm text-sm ${themeClasses.input} ${
                            errors.uploadSpeed ? 'border-red-500 focus:ring-red-500' : ''
                          }`}
                          placeholder="2"
                          min="0.01"
                          step="0.01"
                      ...
                      {errors.uploadSpeed && (
                        <p className="mt-1 text-xs text-red-600">{errors.uploadSpeed}</p>
                      )}
                    </div>
                  </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
                          ...
                          <div className="flex gap-2 w-full sm:w-auto">
                            <EnhancedSelect
                              ...
                              theme={theme}
                            />
                            <span className="text-xs sm:text-sm text-gray-500 whitespace-nowrap flex items-center">
                              ({formatBandwidthDisplay(activeMethod.bandwidthLimit)})
                            </span>
                          </div>
                        </div>
                ...
                <div className={`p-3 sm:p-4 rounded-lg border ${themeClasses.border.light} ${theme === 'dark' ? 'bg-purple-900/10' : 'bg-purple-50'}`}>
                  <h4 className="text-sm sm:text-md font-semibold mb-3 sm:mb-4 text-purple-700 dark:text-purple-300 flex items-center">
                      ...
                      >
                        ...
                        {activeMethod.dataLimit.unit === "Unlimited" && (
                          <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.2 }}
                            className={`p-2 sm:p-3 rounded-lg flex items-center gap-2 ${theme === 'dark' ? 'bg-blue-800/20' : 'bg-blue-100'}`}
                          >
                            <InfinityIcon className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600 dark:text-blue-300 flex-shrink-0" />
                      ...
                      >
                        ...
                        {activeMethod.usageLimit.unit === "Unlimited" && (
                          <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.2 }}
                            className={`p-2 sm:p-3 rounded-lg flex items-center gap-2 ${theme === 'dark' ? 'bg-green-800/20' : 'bg-green-100'}`}
                          >
                            <InfinityIcon className="w-3 h-3 sm:w-4 sm:h-4 text-green-600 dark:text-green-300 flex-shrink-0" />
                ...
                <div className={`p-3 sm:p-4 rounded-lg border ${themeClasses.border.light} ${theme === 'dark' ? 'bg-orange-900/10' : 'bg-orange-50'}`}>
                  <h4 className="text-sm sm:text-md font-semibold mb-3 sm:mb-4 text-orange-700 dark:text-orange-300 flex items-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-3 sm:mt-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      ...
                      <div 
                        ...
                        aria-checked={activeMethod.macBinding}
                        role="switch"
                      >
                        <span className={`inline-block h-4 w-4 transform bg-white rounded-full shadow-md transition-transform duration-200 ease-in-out ${
                          activeMethod.macBinding ? "translate-x-6" : "translate-x-1"
            ...
            <div className={`p-3 sm:p-4 rounded-lg border ${themeClasses.border.light} ${theme === 'dark' ? 'bg-purple-900/10' : 'bg-purple-50'}`}>
              <div className="flex items-center justify-between mb-4">
                ...
                <div 
                  ...
                  aria-checked={templateForm.router_specific}
                  role="switch"
                >
                  <span className={`inline-block h-4 w-4 transform bg-white rounded-full shadow-md transition-transform duration-200 ease-in-out ${
                    templateForm.router_specific ? "translate-x-6" : "translate-x-1"
        ...
        <div className={`p-3 sm:p-4 rounded-lg border ${themeClasses.border.light} ${theme === 'dark' ? 'bg-indigo-900/10' : 'bg-indigo-50'} mt-4 sm:mt-6`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
            <div className={`text-center p-2 sm:p-3 rounded-lg ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
              <Box className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mx-auto mb-1 flex-shrink-0" />
            ...
            <div className={`text-center p-2 sm:p-3 rounded-lg ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
              <Box className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 mx-auto mb-1 flex-shrink-0" />
            ...
            <div className={`text-center p-2 sm:p-3 rounded-lg ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
              <Box className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 mx-auto mb-1 flex-shrink-0" />
              <div className="text-xs sm:text-sm font-semibold truncate">{planSummary.usageLimit}</div>
              <div className="text-xs text-gray-500 truncate">Usage Limit</div>
            </div>
