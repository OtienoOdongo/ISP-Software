...
//                         isSelected
//                           ? planType.color === 'blue'
//                             ? 'border-blue-500 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 shadow-lg shadow-blue-500/20'
//                             : 'border-emerald-500 bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 shadow-lg shadow-emerald-500/20'
...
//                       {/* Icon with Gradient */}
//                       <div className={`p-4 rounded-2xl w-16 h-16 flex items-center justify-center mb-4 bg-gradient-to-r ${planType.gradient} shadow-lg`}>
...
//                 <button
//                   onClick={onClose}
//                   className="px-6 py-3 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-all duration-200 font-medium"
//                 >
//                   Cancel
//                 </button>
...
//                   className={`px-8 py-3 rounded-xl font-semibold flex items-center gap-3 transition-all duration-300 ${
//                     selectedPlanType
