...
//             {/* Bandwidth Limit - Improved with unit selector and conversion */}
//             <div className="mt-6">
...
//           {/* Data & Usage Limits with Clear Distinction */}
...
//             {/* Validity Period - Fixed: No default 720 hours */}
//             <div className="mb-6">
//               <label className={`block text-sm font-medium mb-2 ${themeClasses.text.primary}`}>
...
//             <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-6">
//               {/* Maximum Devices - Improved UX with placeholder */}
//               <div>
//                 <label className={`block text-sm font-medium mb-1 ${themeClasses.text.primary}`}>
...
//           {/* Plan Summary - Fixed: Proper unlimited display */}
