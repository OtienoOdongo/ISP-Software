...
//     const analyticsData = processAnalyticsData(subscriptions, filteredPlansByType, timeRange);
...
//     };
//   }, [plans, analyticsType, subscriptions, timeRange, selectedCategory, templates]);
...
//           <div>
//             <h3 className="text-xl lg:text-2xl font-bold">{totalSubscribers}</h3>
...
//       <Card>
//         <div className="flex items-center">
//           <Activity className="w-6 h-6 lg:w-8 lg:h-8 text-green-600 mr-3 lg:mr-4" />
//           <div>
//             <h3 className="text-xl lg:text-2xl font-bold">{analyticsData.activeSubscriptions}</h3>
...
//           <div>
//             <h3 className="text-xl lg:text-2xl font-bold">{formatCurrency(analyticsData.totalRevenue)}</h3>
...
//       <Card>
//         <div className="flex items-center">
//           <Box className="w-6 h-6 lg:w-8 lg:h-8 text-blue-600 mr-3 lg:mr-4" />
//           <div>
//             <h3 className="text-xl lg:text-2xl font-bold">{filteredPlansByType.length}</h3>
...
//         {analyticsType && (
//           <span className="ml-2 text-sm text-gray-500">({analyticsTypeInfo.name})</span>
//         )}
//       </h3>
//       <div className="space-y-4">
//         {categoryPerformanceData.length > 0 ? (
//           categoryPerformanceData.map((category, index) => (
//             <div key={category.category} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
...
//                 <p className="font-semibold">{category.subscriptions} subs</p>
...
//           <span className="ml-2 text-sm text-gray-500">({analyticsTypeInfo.name})</span>
//         )}
//         {selectedCategory !== "All" && <span className="ml-2 text-sm text-gray-500">({selectedCategory})</span>}
//       </h3>
...
//                 <div className="text-right">
//                   <p className="font-semibold text-lg">{plan.purchases} subscribers</p>
//                   <p className="text-sm text-gray-500 dark:text-gray-400">
...
//       <Card>
//         <h4 className="font-semibold mb-3">Most Popular Category</h4>
//         {categoryPerformanceData.length > 0 ? (
...
//       <Card>
//         <h4 className="font-semibold mb-3">Growth Insights</h4>
//         {categoryPerformanceData.length > 0 ? (
