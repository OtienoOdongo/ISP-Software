...
// export const expiryUnits = Object.freeze(["Hours", "Days", "Months"]);
...
//     accessType: "hotspot", // New field to specify access type
//     accessMethods: {
//       hotspot: {
...
// // Usage limit presets with better organization
...
//   { value: "168", unit: "Hours", label: "1 Week", description: "Weekly reset" },
//   { value: "720", unit: "Hours", label: "1 Month", description: "Monthly reset" },
//   { value: "Unlimited", unit: "Unlimited", label: "Unlimited", description: "No time restrictions" },
//   { value: "custom", unit: "Hours", label: "Custom", description: "Set custom hours" }
// ]);

// // Data limit presets
// export const dataLimitPresets = Object.freeze([
//   { value: "1", unit: "GB", label: "1 GB", description: "Light usage" },
//   { value: "5", unit: "GB", label: "5 GB", description: "Moderate usage" },
...
//   { value: "custom", unit: "GB", label: "Custom", description: "Set custom data" }
// ]);
...
//   { value: "custom", unit: "Days", label: "Custom", description: "Set custom duration" }
// ]);
