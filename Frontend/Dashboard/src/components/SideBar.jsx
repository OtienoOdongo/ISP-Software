              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 p-2.5 rounded-md text-sm font-medium transition-colors duration-300 ${
                    isActive
                      ? theme === "dark"
                        ? "text-indigo-300 bg-indigo-900/30 border-l-4 border-indigo-400"
              ...
              <>
                <li
                  className={`relative flex items-center justify-between p-2.5 rounded-md text-sm cursor-pointer transition-colors duration-300 ${
                    activeMenuIndex === index
                      ? theme === "dark"
                        ? "bg-indigo-900/30 text-indigo-300 border-l-4 border-indigo-400"
                        : "bg-gradient-to-tr from-indigo-200 to-indigo-100 text-indigo-700 border-l-4 border-indigo-500"
                      : theme === "dark"
                      ? "text-gray-300 hover:bg-gray-800/50 hover:text-white"
                      : "text-gray-600 hover:bg-indigo-50"
                  }`}
                ...
                >
                  ...
                  {/* Active Dot */}
                  {activeMenuIndex === index && (
                    <span className={`absolute right-8 top-4 w-2 h-2 rounded-full ${
                      theme === "dark" ? "bg-indigo-400" : "bg-indigo-800"
                    }`} />
                  )}
                        ...
                        <NavLink
                          ...
                          className={({ isActive }) =>
                            `block text-xs px-3 py-2 rounded-md transition-colors duration-300 ${
                              isActive
                                ? theme === "dark"
                                  ? "text-white font-medium bg-gray-800/80"
