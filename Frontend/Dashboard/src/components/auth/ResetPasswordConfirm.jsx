...
const ResetPasswordConfirm = () => {
    ...
    useEffect(() => {
        // Attempt to fetch user profile to check 2FA status
        const check2FA = async () => {
            try {
                const response = await api.get("/api/account/profile/");
                setIs2FAEnabled(response.data.profile.is_2fa_enabled || false);
            } catch (err) {
                ...
                {!success ? (
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-400 mb-6">
                            {is2FAEnabled ? (
                                <>
                                    Your password has been reset. You will need to verify your identity using 2FA on login.
                                    <br />
