...
// // src/components/Plans/CreatePlans.jsx
// import React, { useState, useEffect, useMemo, useCallback } from "react";
// import { motion, AnimatePresence } from "framer-motion";
// import {
//   Plus, Pencil, Trash2, Copy, Eye, ChevronDown, ChevronUp, X, Gift, Wifi, Star, Home, Briefcase,
...
// // Responsive Dropdown Component with dark theme
// const ResponsiveDropdown = ({ 
//   isOpen, 
//   onToggle, 
//   children, 
...
// // Enhanced Select Component with dark theme
// const EnhancedSelect = ({ 
//   value, 
//   onChange, 
//   options, 
...
//               key={index}
//               onClick={() => onSelect(preset.hours || preset.value)}
//               className={`p-3 hover:bg-opacity-50 cursor-pointer flex items-center space-x-3 rounded-lg ${
...
//           transition={{ repeat: Infinity, duration: 1.5 }}
//         >
//           <Copy className="w-4 h-4 text-orange-600 hover:text-orange-800" />
//         </motion.button>
//       }
//       position="right"
//     >
...
//               link.href = url;
//               link.download = `plan-${plan.name}-${new Date().getTime()}.json`;
//               document.body.appendChild(link);
//               link.click();
//               document.body.removeChild(link);
//               URL.revokeObjectURL(url);
//               setCopiedPlanId(null);
//               toast.success(`Plan "${plan.name}" exported as JSON`);
//             }}
//             className="w-full flex items-center space-x-2 px-3 py-2 text-sm rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
//           >
...
//   // Main render functions
//   const renderPlanList = () => (
//     <div className={`min-h-screen p-4 sm:p-8 transition-colors duration-300 ${themeClasses.bg.primary}`}>
...
//               className={`px-4 py-2 rounded-lg shadow-md flex items-center justify-center ${themeClasses.button.primary}`}
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//             >
//               <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
...
//                 setViewMode("form"); 
//               }}
//               className={`px-4 py-2 rounded-lg shadow-md flex items-center justify-center ${themeClasses.button.success}`}
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//             >
//               <Plus className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
...
//         {/* Filters Section */}
//         <div className={`p-6 rounded-xl shadow-lg ${themeClasses.bg.card}`}>
//           <div className="flex flex-col sm:flex-row gap-4">
//             <div className="w-full sm:w-48">
//               <EnhancedSelect
//                 value={filterCategory}
...
//                 value={searchTerm} 
//                 onChange={(e) => setSearchTerm(e.target.value)}
//                 className={`w-full pl-10 pr-4 py-2 rounded-lg shadow-sm ${themeClasses.input}`}
//               />
//             </div>
//           </div>
//         </div>
...
//             <motion.button
//               onClick={() => setViewMode("form")}
//               className={`px-6 py-3 rounded-lg shadow-md ${themeClasses.button.primary}`}
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//             >
...
//             <div className="overflow-x-auto">
//               <table className="min-w-full divide-y" style={{ borderColor: 'inherit' }}>
...
//                         <div className="flex items-center">
//                           {getCategoryIcon(plan.category)}
//                           <span className={`ml-2 text-sm font-medium ${themeClasses.text.primary}`}>
//                             {plan.name}
//                           </span>
//                         </div>
//                       </td>
//                       <td className={`px-4 sm:px-6 py-4 whitespace-nowrap text-sm ${themeClasses.text.secondary}`}>
//                         {plan.planType}
//                       </td>
//                       <td className={`px-4 sm:px-6 py-4 whitespace-nowrap text-sm ${themeClasses.text.secondary}`}>
//                         {plan.category}
...
//                       <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
//                         <div className="flex items-center">
//                           <Users className={`w-4 h-4 mr-2 ${themeClasses.text.tertiary}`} />
...
//                               setActiveTab("basic"); // Always start with basic tab
//                               setViewMode("form"); 
//                             }} 
//                             className="focus:outline-none" 
//                             whileHover={{ rotate: 90 }} 
...
//                       value={form.name || ""} 
//                       onChange={handleChange} 
//                       className={`w-full px-4 py-2 rounded-lg shadow-sm ${themeClasses.input}`}
//                       placeholder="e.g., Rural Wi-Fi Pro" 
//                       required 
//                     />
//                     {errors.name && <p className="text-red-500 text-sm mt-1">{errors.name}</p>}
...
//                         value={form.usageLimit.value || ""} 
//                         onChange={(e) => handleNestedChange("usageLimit", "value", e.target.value)} 
//                         className={`flex-1 px-4 py-2 rounded-lg shadow-sm ${themeClasses.input}`}
//                         placeholder={form.usageLimit.unit === "Unlimited" ? "Unlimited" : "e.g., 720"} 
//                         disabled={form.usageLimit.unit === "Unlimited"} 
//                         required 
//                       />
...
//                               }`}
//                             />
//                             <label className={`ml-2 text-sm ${themeClasses.text.primary}`}>
//                               {router.name || `Router ${router.id}`}
//                             </label>
//                           </div>
//                         ))}
...
//           {activeTab === "features" && (
//             <div className={`p-6 rounded-xl shadow-lg border ${themeClasses.bg.card} ${themeClasses.border.light}`}>
//               <h3 className="text-xl font-semibold mb-4">Features & Restrictions</h3>
...
//                       {form.features.map((feature) => (
//                         <div key={feature} className={`flex items-center justify-between p-2 hover:${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-200'} rounded`}>
//                           <span className={`text-sm ${themeClasses.text.primary}`}>{feature}</span>
//                           <button 
//                             onClick={() => removeListItem("features", feature)} 
//                             className="text-red-600 hover:text-red-800 transition-colors"
//                           >
...
//                     <div className={`space-y-1 max-h-40 overflow-y-auto border rounded-lg p-2 ${themeClasses.border.light} ${theme === 'dark' ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
//                       {form.restrictions.map((restriction) => (
//                         <div key={restriction} className={`flex items-center justify-between p-2 hover:${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-200'} rounded`}>
//                           <span className={`text-sm ${themeClasses.text.primary}`}>{restriction}</span>
//                           <button 
//                             onClick={() => removeListItem("restrictions", restriction)} 
//                             className="text-red-600 hover:text-red-800 transition-colors"
//                           >
...
//           <motion.button 
//             onClick={() => { setViewMode("list"); setForm(deepClone(getInitialFormState())); setEditingPlan(null); }} 
//             className={`px-6 py-2 rounded-lg shadow-md ${themeClasses.button.secondary}`}
//             whileHover={{ scale: 1.05 }}
//             whileTap={{ scale: 0.95 }}
//           >
//             Cancel
...
//             className={`px-6 py-2 rounded-lg shadow-md flex items-center justify-center ${
...
//             {/* Description */}
//             <div className={`p-6 rounded-xl shadow-lg border lg:col-span-2 ${themeClasses.bg.card} ${themeClasses.border.light}`}>
...
//             {selectedPlan.router_specific && (
//               <div className={`p-6 rounded-xl shadow-lg border lg:col-span-2 ${themeClasses.bg.card} ${themeClasses.border.light}`}>
//                 <h3 className="text-xl font-semibold mb-4">Compatible Routers</h3>
//                 {isFetchingCompatible ? (
//                   <div className="flex justify-center py-4">
//                     <FaSpinner className="w-6 h-6 text-indigo-600 animate-spin" />
//                   </div>
...
//                   <div className="space-y-4">
//                     {compatibleRouters.map((router) => (
//                       <div key={router.id} className={`flex items-center justify-between p-4 rounded-lg ${
...
//                         <motion.button 
//                           onClick={() => activatePlanOnRouter(selectedPlan.id, router.id)} 
//                           className={`px-4 py-2 rounded-lg text-sm flex items-center ${themeClasses.button.primary}`}
//                           whileHover={{ scale: 1.05 }}
//                           whileTap={{ scale: 0.95 }}
//                         >
//                           <Zap className="w-4 h-4 mr-2" /> Activate
...
//                 setViewMode("form"); 
//               }} 
//               className={`px-6 py-2 rounded-lg shadow-md flex items-center justify-center ${themeClasses.button.primary}`}
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//             >
//               <Pencil className="w-5 h-5 mr-2" /> Edit Plan
...
//             <motion.button 
//               onClick={() => deletePlan(selectedPlan.id, selectedPlan.name)} 
//               className={`px-6 py-2 rounded-lg shadow-md flex items-center justify-center ${themeClasses.button.danger}`}
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//             >
//               <Trash2 className="w-5 h-5 mr-2" /> Delete Plan
...
//         {/* Subscription Filters */}
//         <div className={`p-6 rounded-xl shadow-lg ${themeClasses.bg.card}`}>
//           <h3 className="text-lg font-semibold mb-4">Filter Subscriptions</h3>
//           <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
//             <div>
...
//             <p className={`mb-6 ${themeClasses.text.secondary}`}>Try adjusting the filters or check back later.</p>
//           </div>
//         ) : (
//           <div className={`rounded-xl shadow-lg overflow-hidden ${themeClasses.bg.card}`}>
//             <div className="overflow-x-auto">
...
//                   <tr>
//                     {["ID", "User", "Plan", "Router", "Status", "Start Date", "End Date", "Data Used", "Time Remaining"].map((header) => (
//                       <th key={header} className={`px-4 sm:px-6 py-3 text-left text-xs font-medium uppercase tracking-wider ${themeClasses.text.secondary}`}>
//                         {header}
//                       </th>
//                     ))}
//                   </tr>
...
//                       <td className={`px-4 sm:px-6 py-4 whitespace-nowrap text-sm ${themeClasses.text.primary}`}>
//                         {sub.id}
//                       </td>
//                       <td className={`px-4 sm:px-6 py-4 whitespace-nowrap text-sm ${themeClasses.text.primary}`}>
//                         {sub.user?.username || "Unknown"}
...
//                   <div>
//                     <h3 className="text-2xl font-bold">{analytics.total_subscriptions}</h3>
...
//                   <div>
//                     <h3 className="text-2xl font-bold">{analytics.active_subscriptions}</h3>
...
//                   <div>
//                     <h3 className="text-2xl font-bold">Ksh {formatNumber(analytics.total_revenue)}</h3>
//                     <p className={`text-sm ${themeClasses.text.secondary}`}>Total Revenue</p>
//                   </div>
//                 </div>
//               </div>
//               <div className={`p-6 rounded-xl shadow-lg border ${themeClasses.bg.card} ${themeClasses.border.light}`}>
...
//                   <div>
//                     <h3 className="text-2xl font-bold">{(analytics.plans || []).length}</h3>
//                     <p className={`text-sm ${themeClasses.text.secondary}`}>Plans Analyzed</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//               {/* Top Plans */}
//               <div className={`p-6 rounded-xl shadow-lg border ${themeClasses.bg.card} ${themeClasses.border.light}`}>
//                 <h3 className="text-xl font-semibold mb-4">Top Plans</h3>
//                 {(analytics.plans || []).length > 0 ? (
//                   <div className="space-y-4">
//                     {(analytics.plans || []).map((plan) => (
//                       <div key={plan.id} className={`flex items-center justify-between p-4 rounded-lg ${
//                         theme === 'dark' ? 'bg-gray-700/50' : 'bg-gray-50'
//                       }`}>
//                         <span className={`text-sm font-medium ${themeClasses.text.primary}`}>
//                           {plan.name}
...
//                   <div className="space-y-4">
//                     {(analytics.recent_subscriptions || []).map((sub) => (
//                       <div key={sub.id} className={`flex items-center justify-between p-4 rounded-lg ${
//                         theme === 'dark' ? 'bg-gray-700/50' : 'bg-gray-50'
//                       }`}>
//                         <div className="flex items-center space-x-3">
...
// // Enhanced Select Component with better mobile support
// const EnhancedSelect = ({ 
//   value, 
//   onChange, 
//   options, 
...
//     >
//       <div className="p-2">
//         <div className="text-xs font-medium px-2 py-1 border-b mb-1 border-gray-600/30">
...
// // Category Dropdown Component - Enhanced for mobile and desktop
// const CategoryDropdown = ({ value, onChange, className = "", availableCategories = categories, includeAll = true }) => {
//   const [isOpen, setIsOpen] = useState(false);
//   const { theme } = useTheme();
//   const themeClasses = getThemeClasses(theme);
...
//     value: cat,
//     label: cat,
//     icon: cat === "Residential" ? Home : 
//           cat === "Business" ? Briefcase : 
//           cat === "Promotional" ? Gift : 
//           Server
//   }));

//   const displayCategories = includeAll 
//     ? [{ value: "All", label: "All Categories", icon: Home }, ...categoryOptions]
//     : categoryOptions;

//   const selectedCategory = displayCategories.find(cat => cat.value === value);

//   const placeholder = includeAll ? "Select Category" : "Select Category";
...
//       trigger={
//         <div className={`
//           flex items-center justify-between w-full px-3 py-2 rounded-lg border text-sm cursor-pointer
//           ${themeClasses.input} ${className}
//         `}>
//           <div className="flex items-center space-x-2">
//             {selectedCategory?.icon && React.createElement(selectedCategory.icon, { 
...
//               }}
//               className={`
//                 px-3 py-2 cursor-pointer transition-colors text-sm flex items-center space-x-2
//                 ${isSelected 
//                   ? 'bg-indigo-600 text-white' 
//                   : theme === 'dark'
//                     ? 'hover:bg-gray-700'
...
//             {/* Category Filter - ENHANCED FOR MOBILE & DESKTOP */}
