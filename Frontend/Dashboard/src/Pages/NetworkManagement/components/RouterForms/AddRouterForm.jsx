...
import { 
  ...
  Wifi, Users, FileText, TestTube, Cpu, Server 
} from "lucide-react";
import CustomModal from "../Common/CustomModal";
import CustomButton from "../Common/CustomButton";
import InputField from "../Common/InputField";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <div className={`px-3 py-2 rounded-lg text-sm font-medium ${
                routerForm.connection_status === 'connected' 
                  ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300'
                  : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'
              }`}>
                {routerForm.connection_status === 'connected' ? 'Connected' : 'Disconnected'}
              </div>
            </div>
            ...
            <div>
              ...
              <div className={`px-3 py-2 rounded-lg text-sm font-medium ${
                routerForm.configuration_status === 'configured' 
                  ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300'
                  : routerForm.configuration_status === 'partially_configured'
                  ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300'
                  : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'
              }`}>
                {routerForm.configuration_status === 'configured' ? 'Configured' : 
                 routerForm.configuration_status === 'partially_configured' ? 'Partial' : 'Not Configured'}
              </div>
            </div>
