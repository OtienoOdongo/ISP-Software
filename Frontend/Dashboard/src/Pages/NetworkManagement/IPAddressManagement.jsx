...
//   AlertCircle, ArrowRight, Download, Upload, Activity
// } from 'lucide-react';
// import { ToastContainer, toast } from 'react-toastify';
// import 'react-toastify/dist/ReactToastify.css';

// const IPAddressManagement = ({ routerId }) => {
//   const [ipAddresses, setIPAddresses] = useState([]);
//   const [searchTerm, setSearchTerm] = useState('');
//   const [sortConfig, setSortConfig] = useState({ key: 'ip_address', direction: 'ascending' });
//   const [currentPage, setCurrentPage] = useState(1);
...
//       status: 'assigned', 
//       assigned_to: 'Main Router', 
//       description: 'Primary network gateway', 
//       subnet: { network_address: '192.168.1.0', netmask: '255.255.255.0' },
//       bandwidth_limit: '100Mbps',
//       priority: 'high',
//       last_used: '2023-05-20T14:30:00Z',
...
//       status: 'available', 
//       assigned_to: '', 
//       description: 'Available for new devices', 
//       subnet: { network_address: '192.168.1.0', netmask: '255.255.255.0' },
//       bandwidth_limit: '',
//       priority: 'medium',
//       last_used: '',
...
//       status: 'reserved', 
//       assigned_to: 'NAS Server', 
//       description: 'Network attached storage', 
//       subnet: { network_address: '192.168.1.0', netmask: '255.255.255.0' },
//       bandwidth_limit: '50Mbps',
//       priority: 'high',
//       last_used: '2023-05-20T08:45:00Z',
...
//       try {
//         setLoading(true);
//         // In production: const response = await api.get(`/routers/${routerId}/ip-addresses`);
...
//       ip.subnet.network_address.toLowerCase().includes(searchTerm.toLowerCase())
//   );
...
//           ip.id === editIP.id ? { ...ip, ...newIP, updated_at: new Date().toISOString() } : ip
//         ));
//         toast.success('IP address updated successfully');
//       } else {
//         const newId = Math.max(...ipAddresses.map(ip => ip.id), 0) + 1;
//         setIPAddresses([...ipAddresses, { ...newIP, id: newId }]);
//         toast.success('IP address added successfully');
//       }
//       resetForm();
//     } catch (error) {
//       toast.error('Error saving IP address');
//     }
//   };
...
//       case 'reserved': return 'bg-yellow-500/20 text-yellow-500';
...
//           <div>
//             <h1 className="text-2xl font-bold text-indigo-400">IP Address Management</h1>
...
//           className="flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-md"
//         >
...
//         </div>
//         <select 
//           className="p-2 bg-gray-700 border border-gray-600 rounded-md text-gray-200 text-sm"
//           onChange={(e) => handleSort(e.target.value)}
//         >
//           <option value="ip_address">Sort by IP</option>
//           <option value="status">Sort by Status</option>
//           <option value="assigned_to">Sort by Assigned To</option>
//           <option value="subnet.network_address">Sort by Subnet</option>
...
//                 <tr>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer" onClick={() => handleSort('ip_address')}>
//                     IP Address
//                   </th>
...
//                     Status
//                   </th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer" onClick={() => handleSort('assigned_to')}>
//                     Assigned To
//                   </th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">
//                     Bandwidth
//                   </th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer" onClick={() => handleSort('subnet.network_address')}>
//                     Subnet
//                   </th>
//                   <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">
//                     Last Used
...
//                           </div>
//                           <div className="ml-4">
//                             <div className="text-sm font-medium text-gray-200">{ip.ip_address}</div>
//                             <div className="text-xs text-gray-400">{ip.description}</div>
//                           </div>
//                         </div>
//                       </td>
//                       <td className="px-6 py-4 whitespace-nowrap">
...
//                       </td>
//                       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-200">
//                         {ip.subnet.network_address}/{ip.subnet.netmask}
//                       </td>
...
//                                   <p className={`text-gray-200 ${getStatusColor(ip.status)}`}>
//                                     {ip.status.charAt(0).toUpperCase() + ip.status.slice(1)}
//                                   </p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Assigned To</p>
//                                   <p className="text-gray-200">{ip.assigned_to || 'Not assigned'}</p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Bandwidth Limit</p>
//                                   <p className="text-gray-200">{ip.bandwidth_limit || 'Unlimited'}</p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Priority</p>
//                                   <p className={`text-gray-200 ${getPriorityColor(ip.priority)}`}>
//                                     {ip.priority.charAt(0).toUpperCase() + ip.priority.slice(1)}
//                                   </p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Created</p>
//                                   <p className="text-gray-200">{timeSince(ip.created_at)}</p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Last Used</p>
//                                   <p className="text-gray-200">{timeSince(ip.last_used)}</p>
//                                 </div>
//                               </div>
//                             </div>
//                             <div>
...
//                                   <p className="text-gray-200">{ip.ip_address}</p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Subnet</p>
//                                   <p className="text-gray-200">{ip.subnet.network_address}/{ip.subnet.netmask}</p>
//                                 </div>
//                                 <div>
//                                   <p className="text-gray-400">Description</p>
//                                   <p className="text-gray-200">{ip.description || 'No description'}</p>
//                                 </div>
...
//         <div className="flex justify-between items-center mt-4 px-4 py-3 bg-gray-800 rounded-b-lg">
...
//                 className={`px-3 py-1 rounded-md ${currentPage === page ? 'bg-indigo-600 text-white' : 'bg-gray-700 text-gray-300'}`}
//               >
//                 {page}
//               </button>
//             ))}
...
//                       className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md text-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
//                     />
//                   </div>
...
//                   <div>
//                     <label className="block text-sm font-medium text-gray-300 mb-1">Netmask</label>
//                     <input
//                       type="text"
//                       name="netmask"
//                       value={newIP.subnet.netmask}
...
//                   <div className="md:col-span-2">
//                     <label className="block text-sm font-medium text-gray-300 mb-1">Bandwidth Limit (optional)</label>
//                     <input
//                       type="text"
...
//     try {
//       setLoading(true);
//       const response = await api.get(`/api/ip-addresses/?router=${routerId}&page=${currentPage}&per_page=${itemsPerPage}`);
...
//       setLoading(false);
//     }
//   }, [routerId, currentPage, itemsPerPage]);
...
//       const payload = { ...newIP };
//       if (editIP) {
//         await api.put(`/api/ip-addresses/${editIP.id}/`, payload);
//         toast.success('IP address updated successfully');
//       } else {
//         await api.post('/api/ip-addresses/', payload);
//         toast.success('IP address added successfully');
//       }
//       fetchIPAddresses();
//       resetForm();
...
//     try {
//       await api.delete(`/api/ip-addresses/${id}/`);
//       toast.success('IP address deleted');
//       fetchIPAddresses();
//     } catch (error) {
//       toast.error('Error deleting IP address');
//     }
//   };
...
//                       type="text"
//                       name="assigned_to"
//                       value={newIP.assigned_to?.full_name || ''}
//                       onChange={handleInputChange}
//                       placeholder="Device or service name"
//                       className="w-full p-2 bg-white border border-gray-300 rounded-md text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
//                     />
...
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 mb-1">Bandwidth Limit (optional)</label>
//                     <input
//                       type="text"
//                       name="bandwidth_limit"
//                       value={newIP.bandwidth_limit}
...
// import { 
//   Plus, Edit, Trash2, Search, ChevronDown, ChevronUp,
//   Server, HardDrive, Network, CheckCircle, XCircle, Clock,
//   AlertCircle
// } from 'lucide-react';
// import { ToastContainer, toast } from 'react-toastify';
// import 'react-toastify/dist/ReactToastify.css';
...
//         `/api/network_management/ip-addresses/?router=${routerId}&page=${currentPage}&per_page=${itemsPerPage}&search=${searchTerm}`
//       );
...
//       toast.error(error.response?.data?.error || 'Failed to fetch IP addresses');
//     } finally {
//       setLoading(false);
//     }
//   }, [routerId, currentPage, itemsPerPage, searchTerm]);
...
//         ...newIP,
//         router: routerId,
//         assigned_to: newIP.assigned_to?.id || null
//       };
...
//       toast.error(error.response?.data?.error || 'Error saving IP address');
//     }
//   };
...
//       toast.error(error.response?.data?.error || 'Error deleting IP address');
//     }
//   };
...
//             <h1 className="text-2xl font-bold text-indigo-600">IP Address Management</h1>
//             <p className="text-sm text-gray-500">
//               {totalItems} IPs • {ipAddresses.filter(ip => ip.status === 'assigned').length} assigned
//             </p>
//           </div>
//         </div>
//         <button 
...
//         <div className="flex justify-between items-center mt-4 px-4 py-3 bg-gray-50 rounded-b-lg">
//           <div className="text-sm text-gray-500">
//             Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, totalItems)} of {totalItems} IPs
//           </div>
//           <div className="flex space-x-2">
//             <button
//               onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
...
//                   className={`px-3 py-1 rounded-md ${currentPage === pageNum ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700'}`}
//                 >
//                   {pageNum}
//                 </button>
//               );
...
//       setLoading(true);
//       setError(null);
//       const response = await api.get(`/api/network_management/ip-addresses/?router=${routerId}&page=${currentPage}&per_page=${itemsPerPage}`);
//       setIPAddresses(response.data.data);
//       setTotalPages(response.data.total_pages);
//     } catch (error) {
//       setError(error.response?.data?.error || 'Failed to fetch IP addresses');
//       toast.error(error.response?.data?.error || 'Failed to fetch IP addresses');
//     } finally {
//       setLoading(false);
//     }
...
//     try {
//       const payload = { ...newIP, router: parseInt(routerId) };
//       if (editIP) {
//         await api.put(`/api/network_management/ip-addresses/${editIP.id}/`, payload);
//         toast.success('IP address updated successfully');
//       } else {
...
//           onClick={() => setShowModal(true)}
//           className="flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-md"
//           disabled={!routerId || isNaN(parseInt(routerId))}
//         >
//           <Plus className="w-5 h-5 mr-2" />
//           Add IP Address
//         </button>
