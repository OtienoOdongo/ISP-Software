...
//                         className="bg-white/5 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-gray-700/50 transition-colors duration-300 flex flex-col"
//                       >
...
//                           }
//                         >
//                           {isPromotionalZero ? "Activate Now" : "Get Started"}
//                         </button>
//                       </motion.div>
//                     );
//                   })}
