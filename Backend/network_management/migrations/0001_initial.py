...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["router", "test_type"], name="network_man_router__3edc63_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="diagnostictest",
            index=models.Index(
                fields=["created_at"], name="network_man_created_0e25c4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="speedtesthistory",
            index=models.Index(
                fields=["router", "timestamp"], name="network_man_router__cb6752_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="speedtesthistory",
            index=models.Index(
                fields=["client_ip"], name="network_man_client__0d187c_idx"
            ),
        ),
    ]
