...
class PricingService:
    ...
    def get_tax_rate(cls):
        """Get configurable tax rate"""
        return getattr(settings, 'DEFAULT_TAX_RATE', Decimal('0.16'))  # 16% VAT for Kenya default
    ...
    def calculate_final_price(cls, plan, quantity=1, discount_code=None, client_data=None):
        ...
        # Add tax calculation (configurable)
        tax_rate = cls.get_tax_rate()
