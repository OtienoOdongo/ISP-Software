# Generated by Django 5.1.3 on 2025-04-03 14:49
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "plan_type",
                    models.CharField(
                        choices=[("Paid", "Paid"), ("Free Trial", "Free Trial")],
                        default="Paid",
                ...
                (
                    "usage_limit_unit",
                    models.CharField(
                        choices=[("Hours", "Hours"), ("Unlimited", "Unlimited")],
                        default="Hours",
                ...
                (
                    "created_at",
                    models.DateField(
                        auto_now_add=True, help_text="Date when this plan was created"
                    ),
                ),
                (
                    "client_sessions",
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="internet_pl_name_f76fde_idx"),
                    models.Index(
                        fields=["category"], name="internet_pl_categor_df600f_idx"
                    ),
                    models.Index(
                        fields=["plan_type"], name="internet_pl_plan_ty_6076ba_idx"
                    ),
                    models.Index(
                        fields=["active"], name="internet_pl_active_566f83_idx"
                    ),
                ],
            },
        ),
