...
#             print(f"Error in GET /api/internet_plans/: {str(e)}")
...
#             serializer.save()
#             print("Plan created successfully:", serializer.data)
...
#         except Exception as e:
#             print(f"Error in GET /api/internet_plans/{pk}/: {str(e)}")
#             return Response({'error': str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)

#     def put(self, request, pk):
#         try:
#             print(f"Received PUT data for pk={pk}:", request.data)
#             plan = get_object_or_404(InternetPlan, pk=pk)
#             serializer = InternetPlanSerializer(plan, data=request.data, partial=True)
#             if serializer.is_valid():
#                 serializer.save()
#                 return Response(serializer.data, status=status.HTTP_200_OK)
#             print(f"Serializer errors for pk={pk}:", serializer.errors)
#             return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
#         except Exception as e:
#             print(f"Error in PUT /api/internet_plans/{pk}/: {str(e)}")
#             return Response({'error': str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
#         except Exception as e:
#             print(f"Error in DELETE /api/internet_plans/{pk}/: {str(e)}")
#             return Response({'error': str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
