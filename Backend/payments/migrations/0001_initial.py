# Generated by Django 5.2.3 on 2026-02-02 10:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_type', models.CharField(choices=[('hotspot', 'Hotspot'), ('pppoe', 'PPPoE'), ('both', 'Both')], default='hotspot', help_text='Type of access method (Hotspot/PPPoE/Both)', max_length=10)),
                ...
                ('phone_number', models.CharField(blank=True, help_text='Phone number used for payment (for M-Pesa transactions)', max_length=20, null=True)),
                ('reference_number', models.CharField(blank=True, max_length=100, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('metadata', models.JSONField(blank=True, default=dict)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('client', models.ForeignKey(help_text='Client user associated with this transaction', limit_choices_to={'user_type': 'client'}, on_delete=django.db.models.deletion.CASCADE, related_name='transaction_logs', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performed_by', models.ForeignKey(blank=True, help_text='Admin/staff user who performed the action', limit_choices_to={'user_type__in': ['staff', 'admin']}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            model_name='transactionlog',
            index=models.Index(fields=['client', 'status'], name='payments_tr_client__6b56d1_idx'),
        ),
        migrations.AddIndex(
            model_name='transactionlog',
            index=models.Index(fields=['client', 'created_at'], name='payments_tr_client__e7ef4a_idx'),
        ),
        migrations.AddIndex(
            model_name='transactionlog',
            index=models.Index(fields=['client', 'access_type'], name='payments_tr_client__32d14a_idx'),
        ),
        migrations.AddIndex(
            model_name='transactionloghistory',
            index=models.Index(fields=['transaction_log', 'timestamp'], name='payments_tr_transac_256368_idx'),
        ),
        migrations.AddIndex(
            model_name='transactionloghistory',
            index=models.Index(fields=['action', 'timestamp'], name='payments_tr_action_1c3751_idx'),
        ),
        migrations.AddIndex(
            model_name='transactionloghistory',
            index=models.Index(fields=['performed_by', 'timestamp'], name='payments_tr_perform_38ed3e_idx'),
        ),
        migrations.AddIndex(
            model_name='transactionloghistory',
            index=models.Index(fields=['new_status', 'timestamp'], name='payments_tr_new_sta_22763a_idx'),
        ),
    ]
